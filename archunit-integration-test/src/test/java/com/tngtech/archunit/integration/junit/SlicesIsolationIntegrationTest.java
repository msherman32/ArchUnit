    ...
    static void expectSliceViolationsFromDependencies(ExpectsViolations expectsViolations) {
        ...
        expectsViolations
                .by(sliceDependency()
                        ...
                        .by(accessFromMethod(UseCaseOneTwoController.class, doSomethingOne)
                ...
                .by(sliceDependency()
                        ...
                        .by(accessFromMethod(UseCaseThreeController.class, doSomethingThree)
    ...
    static void expectSliceViolationsFromDependenciesWithIgnore(ExpectsViolations expectsViolations) {
        expectsViolations.ofRule("Controllers should not depend on each other")
                .by(sliceDependency()
                        ...
                        .by(accessFromMethod(UseCaseOneThreeController.class, doSomethingOne)
                ...
                .by(sliceDependency()
                        ...
                        .by(accessFromMethod(UseCaseTwoController.class, doSomethingTwo)
                                .toConstructor(UseCaseOneTwoController.class)
                                .inLine(9))
                        .by(accessFromMethod(UseCaseTwoController.class, doSomethingTwo)
                                .toMethod(UseCaseOneTwoController.class, doSomethingOne)
